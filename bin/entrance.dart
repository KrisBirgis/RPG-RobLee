...
class Restaurant extends Rooms {

  String description;
  Restaurant({this.description}) : super(description: description, name: 'Restaurant');
}

class Room103 extends Rooms{

  String description;
  Room103({this.description}) : super (description: description, name: 'Room 103');
}

class SexDungeon extends Rooms{
